  ...
  helm-ui = {
    ...
    deploy_parameters = {
      ...
      urlHelidonGraal = {
        ...
        default_value = "http://ingress.cloud-coach.ivandelic.com/warp-engine-c2/universe/traverse"
      }
      urlHelidonC2 = {
        name = "urlHelidonC2"
        default_value = "http://ingress.cloud-coach.ivandelic.com/warp-engine-graal/universe/traverse"
      }
      urlMicronautNative = {
        name = "urlMicronautNative"
        default_value = "http://ingress.cloud-coach.ivandelic.com/warp-engine-native/universe/traverse"
      }
      urlHelm = {
        name = "urlHelm"
        default_value = "helm-ui.cloud-coach.ivandelic.com"
      }
    }
  }
  warp-engine-c2 = {
    ...
    deploy_parameters = {
      ...
      urlHelidonC2 = {
        name = "urlHelidonC2"
        default_value = "warp-engine-c2.cloud-coach.ivandelic.com"
      }
      helidonC2NodeLabel = {
        name = "helidonC2NodeLabel"
        default_value = "EU-FRANKFURT-1-AD-3"
      }
    }
  }
  warp-engine-graal = {
    ...
    deploy_parameters = {
      ...
      urlHelidonGraal = {
        name = "urlHelidonGraal"
        default_value = "warp-engine-graal.cloud-coach.ivandelic.com"
      }
      helidonGraalNodeLabel = {
        name = "helidonGraalNodeLabel"
        default_value = "EU-FRANKFURT-1-AD-2"
      }
    }
  }
  warp-engine-native = {
    ...
    build_parameters = {
      ...
      micronautNativeImageBaseUrl = {
        ...
        default_value = "fra.ocir.io/frsxwtjslf35/cloud-coach-automate-deployments/warp-engine-native"
        description = "changed"
      }
    }
    deploy_parameters = {
      ...
      micronautNativeNodeLabel = {
        name = "micronautNativeNodeLabel"
        default_value = "EU-FRANKFURT-1-AD-1"
      }
      urlMicronautNative = {
        name = "urlMicronautNative"
        default_value = "warp-engine-native.cloud-coach.ivandelic.com"
      }
    }
  }
}